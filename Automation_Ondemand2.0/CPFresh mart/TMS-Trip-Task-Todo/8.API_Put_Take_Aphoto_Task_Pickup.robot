...
Read variable text    
    ${TodoID_PICKUP[2]}=    Get File                      TodoID_PICKUP[2].txt
    ${Token}=    Get File                          TokenDriver.txt
    Set Global Variable                            ${TodoID_PICKUP[2]}  
    Set Global Variable                            ${Token} 

TC_001_PUT TAKE A PHOTO TASK PICKUP SUCCESS
...
TC_002_PUT TAKE A PHOTO TASK PICKUP DUPLICATE
    Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
    ${headers}=                                   Create Dictionary           Authorization=${Token}                               Content-Type=${Content-Type}     project-id=5ec78aecf3a41244b9031586    company-id=5ea93cda890a1f52c86637e3    
    ${json_string}                                Get File                    TC_009_Take_Photo.json
    ${resp}=                                      PUT Request                 session                                              /v1/todos/${TodoID_PICKUP[2]}    data=${json_string}                    headers=${headers} 
...
TC_003_PUT take a photo pick up access token if invalid username or password
    Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
...
# TC_004_PUT take a photo task pick up Time out
#     Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
#     ${headers}=                                   Create Dictionary           Authorization=${Token}                                Content-Type=${Content-Type}     project-id=5ec78aecf3a41244b9031586    company-id=5ea93cda890a1f52c86637e3    
#     ${json_string}                                Get File                    TC_009_Take_Photo.json
#     ${resp}=                                      PUT Request                 session                                              /v1/todos/${TodoID_PICKUP[2]}    data=${json_string}                    headers=${headers} 
...
TC_005_PUT take a photo task pick up data not found
    Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
    ${headers}=                                   Create Dictionary           Authorization=${Token}                                Content-Type=${Content-Type}     project-id=5ec78aecf3a41244b9031586    company-id=5ea93cda890a1f52c86637e3    
    ${json_string}                                Get File                    TC_009_Take_Photo.json
...
TC_006_PUT take a photo task pick up path environment incorect
    Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
    ${headers}=                                   Create Dictionary           Authorization=${Token}                                Content-Type=${Content-Type}     project-id=5ec78aecf3a41244b9031586    company-id=5ea93cda890a1f52c86637e3    
    ${json_string}                                Get File                    TC_009_Take_Photo.json
    ${resp}=                                      PUT Request                 session                                              /v1/todosxxx/${TodoID_PICKUP[2]}    data=${json_string}                    headers=${headers} 
    ${http_status_res_code}=                      Set Variable                ${resp.status_code}                                  
    log                                           ${resp.json()}              
...
TC_007_PUT take a photo task pick up required field "lat"
    Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
    ${headers}=                                   Create Dictionary           Authorization=${Token}                                Content-Type=${Content-Type}     project-id=5ec78aecf3a41244b9031586    company-id=5ea93cda890a1f52c86637e3    
...
TC_008_PUT take a photo task pick up required field "lng"
    Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
    ${headers}=                                   Create Dictionary           Authorization=${Token}                                Content-Type=${Content-Type}     project-id=5ec78aecf3a41244b9031586    company-id=5ea93cda890a1f52c86637e3    
...
TC_009_PUT take a photo task pick up required field "images"
    Create Session                                session                     http://app-4pl-tms-api.drivs.staging.tel.internal
    ${headers}=                                   Create Dictionary           Authorization=${Token}                                Content-Type=${Content-Type}     project-id=5ec78aecf3a41244b9031586    company-id=5ea93cda890a1f52c86637e3    
