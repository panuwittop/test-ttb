...
GET APPOINTMENT TYPE RULE 2
    Create Session    session              ${wfm_host} 
    ${headers}=       Create Dictionary    x-api-key=${api-key}               Content-Type=${Content-Type}    
    ${json_string}    Get File             BODY_GET_APPOINTMENT_TYPE2.json
...
GET APPOINTMENT TYPE RULE 3
    Create Session    session              ${wfm_host} 
    ${headers}=       Create Dictionary    x-api-key=${api-key}               Content-Type=${Content-Type}    
    ${json_string}    Get File             BODY_GET_APPOINTMENT_TYPE3.json
...
GET APPOINTMENT TYPE RULE 4
    Create Session    session              ${wfm_host} 
    ${headers}=       Create Dictionary    x-api-key=${api-key}               Content-Type=${Content-Type}    
    ${json_string}    Get File             BODY_GET_APPOINTMENT_TYPE4.json
...
GET APPOINTMENT TYPE RULE 7
    Create Session    session              ${wfm_host} 
    ${headers}=       Create Dictionary    x-api-key=${api-key}               Content-Type=${Content-Type}    
    ${json_string}    Get File             BODY_GET_APPOINTMENT_TYPE7.json
...
GET APPOINTMENT TYPE RULE 8
    Create Session    session              ${wfm_host} 
    ${headers}=       Create Dictionary    x-api-key=${api-key}               Content-Type=${Content-Type}    
    ${json_string}    Get File             BODY_GET_APPOINTMENT_TYPE8.json
...
GET APPOINTMENT TYPE RULE 9
    Create Session    session              ${wfm_host} 
    ${headers}=       Create Dictionary    x-api-key=${api-key}               Content-Type=${Content-Type}    
    ${json_string}    Get File             BODY_GET_APPOINTMENT_TYPE9.json
...
GET APPOINTMENT TYPE RULE 10
    Create Session    session              ${wfm_host} 
    ${headers}=       Create Dictionary    x-api-key=${api-key}               Content-Type=${Content-Type}    
    ${json_string}    Get File             BODY_GET_APPOINTMENT_TYPE10.json
